...
class ChatConversation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatConversationController>(builder: (_)=>Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                IconButton(onPressed:()=>_homeController.bottomNavPop(), icon:
                Icon(Icons.arrow_back,color: MyColor.mainColor,)),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    "${EkuaboString.conversation_with} ${chatBean.username}".text
                        .medium
                        .heightTight
                        .size(18)
                        .make(),
              ...
              children: [
                VxBox(
                    child: ListView.builder(itemBuilder:(ctx,index){
                      return _con.chatList[index].toUserId!=chatBean.chatId?Row(
                              ...
                              VxBox(
                                  child:Row(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: _con.chatList[index].profileImg??'',
                                      ...
                                      10.widthBox,
                                      _con.chatList[index].message
                                          .text
                                          .maxLines(1)
                                          .ellipsis
                                          .size(14)
                                          .medium
                                          .makeCentered().pOnly(right: 10),
                                    ],
                                  )
                              )
                                  .border(color: MyColor.mainColor,width: 0.6)
                                  .withRounded(value: 7)
                                  .height(30)
                                  .make().pOnly(left: 10),
                              10.widthBox,
                    ...
                    .white.withRounded(value: 10).width(double.infinity)
                    .make().p(16),
                16.heightBox,
                Row(
                  children: [
                    ...
                    Expanded(
                        flex:1,
                        child: Image.asset(EkuaboAsset.ic_send2,
                          width: 16,
                          height: 16,
