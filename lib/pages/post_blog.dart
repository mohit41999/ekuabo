...
class PostBlog extends StatelessWidget {
  ...
  final _con = Get.find<PostBlogController>();
  @override
            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    EkuaboString.post_a_blog.text.medium
                        .size(18)
                        .make()
                        .pOnly(left: 10),
                ...
                Form(
                  ...
                  children: [
                    ...
                    ConstrainedBox(
                      ...
                      child: TextFormField(
                        controller: _con.blogTitleCtl,
                        keyboardType: TextInputType.text,
                        decoration: const InputDecoration(
                            filled: true,
                            labelText: EkuaboString.enterBlogTitle,
                            hintText: EkuaboString.enterBlogTitle,
                    ...
                    Row(
                      children: [
                        Flexible(
                          child: GetBuilder<PostBlogController>(
                            builder: (_) => _con.mediaFile == null
                                ? EkuaboString.uploadImage.text.medium
                                    .size(11)
                                    .make()
                                : _con.mediaFile.path
                                    .substring(
                                        _con.mediaFile.path.lastIndexOf('/') +
                                            1,
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          labelText: EkuaboString.enterBlogDesc,
                          hintText: EkuaboString.enterBlogDesc,
                          labelStyle: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w200,
                              color: MyColor.blackColor),
