...
class CreateMyAd extends StatelessWidget {
  final _homeController=Get.find<HomeController>();
  final _con=Get.find<AddBannerController>();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddBannerController>(builder:(_)=>Scaffold(
      backgroundColor: Colors.white,
      appBar: EcuaboAppBar().getAppBar(),
      body: _con.bannerSlots.isNotEmpty?SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                IconButton(onPressed:()=>_homeController.bottomNavPop(), icon: Icon(Icons.arrow_back,color: MyColor.mainColor
                  ,)),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    EkuaboString.myPostedBannerAd
                        .text
                        .medium
                        .heightTight
                        .size(18)
              ...
              children: [
                Form(
                    child: Column(
                      ...
                      children: [
                        ConstrainedBox(
                          constraints:const BoxConstraints(minHeight:10,maxHeight: 40),
                          child: TextFormField(
                        ...
                        VxBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                ListView.builder(itemBuilder:(context,index)=>Row(
                                  children: [
                                    Expanded(flex:2,child: Checkbox(value: _con.bannerSlots[index].isChecked, onChanged:(v){
                                      _con.bannerSlots[index].isChecked=!_con.bannerSlots[index].isChecked;
                                      _con.update();
                                    })),
                                    Expanded(
                                      flex:2,
                            ...
                            .white.width(double.infinity).make(),
                        16.heightBox,
                        Row(
                          children: [
                            _con.mediaFile==null?EkuaboString.uploadBannerImage
                                .text
                                .medium
                                .size(11)
                                .make():_con.mediaFile
                                .path
                                .substring(_con.mediaFile.path.lastIndexOf('/')+1,_con.mediaFile.path.length).text
                                .medium
                                .size(11)
                                .make(),
                            10.widthBox,
                            Image.asset(EkuaboAsset.ic_upload,
                              width: 21,
                              height: 14,
                            )
                          ],
                ...
                MaterialButton(
                  minWidth: 170,
                  onPressed: () =>_con.createMyAd(context,_homeController),
  ...
  _imgFromCamera() async {
    var image = await _con.picker.getImage(
