...
class PrivateMessageBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
      ...
      body: GetBuilder<PrivateMessageBoardController>(builder: (_)=>SingleChildScrollView(
        physics: BouncingScrollPhysics(),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            EkuaboString.private_message_board
                .text
                .medium
                .size(18)
                .heightTight
            ...
            ConstrainedBox(
              ...
              child: VxCard(Column(
                children: [
                  16.heightBox,
                  _con.chatList.isEmpty?EkuaboString.no_results_found
                      .text
                      .color(MyColor.blackColor)
                      .size(10)
                      .makeCentered().pOnly(left: 10):ListView.builder(itemBuilder:(ctx,index){
                    return  Dismissible(
                      key: Key("$index"),
                      onDismissed: (direction)=>_con.deleteChat(index),
                      background: Icon(Icons.delete,color: MyColor.mainColor,size: 24,).pOnly(right: Get.width-150),
                      ...
                      child: VxBox(
                              ...
                              SizedBox(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: _con.chatList[index].userImg??'',
                          ...
                          .border(color: MyColor.lightGrey,
                          width: 0.6
                        ...
                        _homeController.bottomNavigatorKey.currentState.pushNamed(EkuaboRoute.chatConversation,arguments: _con.chatList[index]);
                      }),
                    );
                  ...
                  16.heightBox,
                  _con.chatList.isNotEmpty?Column(
                    children: [
                      Image.asset(EkuaboAsset.ic_swipe_to_delete,
                        height: 16,
                      ),
                      10.heightBox,
                      EkuaboString.swipe_to_delete_conversation
                          .text
                          .size(10)
                          .medium
                  ...
                  .make().w(double.infinity).pOnly(left: 16,right: 16),
            ),
