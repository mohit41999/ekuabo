...
class UserMarketPlaceDetails extends StatefulWidget {
  final String market_id;

  const UserMarketPlaceDetails({Key key, @required this.market_id})
      : super(key: key);
  @override
  State<UserMarketPlaceDetails> createState() => _UserMarketPlaceDetailsState();
}

class _UserMarketPlaceDetailsState extends State<UserMarketPlaceDetails> {
  ...
  Future<MarketplaceDetails> getmarketplacedetails() async {
    ...
    var response = await http.post(
        ...
        body: {
          ...
          'token': '123456789',
          'marketplace_id': '${widget.market_id}'
        });
